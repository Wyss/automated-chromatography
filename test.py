...
class MainWindow(QMainWindow):
    ...
    #serial port
        #self.serial = PySide6.QtSerialPort.QSerialPort(self, readyRead = self.receive)
        self.serial = PySide6.QtSerialPort.QSerialPort(self)
    #define methods
    ...
    def serialConnect(self):
        ...
        #self.serial.setBaudRate(PySide6.QtSerialPort.QSerialPort.Baud9600)
        self.serial.setBaudRate(PySide6.QtSerialPort.QSerialPort.Baud38400)
        self.serial.setDataBits(PySide6.QtSerialPort.QSerialPort.Data8)
        self.serial.setParity(PySide6.QtSerialPort.QSerialPort.NoParity)
        self.serial.setStopBits(PySide6.QtSerialPort.QSerialPort.OneStop)
        self.serial.setFlowControl(PySide6.QtSerialPort.QSerialPort.NoFlowControl)

        if(self.serial.open(PySide6.QtCore.QIODevice.ReadWrite)):
            #if connection is successful:
            print("Connection Successful")
            self.serialInfo = PySide6.QtSerialPort.QSerialPortInfo(portname)
...
if __name__ == "__main__":
    ...
    for info in PySide6.QtSerialPort.QSerialPortInfo.availablePorts():
